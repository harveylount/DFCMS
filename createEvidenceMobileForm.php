        ...
        <section id="content">
            ...
            <form method="post" action="createEvidenceMobileInsert.php?identifier=<?php echo "$identifier" ?>">
                <fieldset class="field-set width">
                    ...
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtSIMM']; unset($_SESSION['txtSIMM']);?></p> [Carrier, ICCID, SIM Size]<br /><br />
                    ...
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtNumberM']; unset($_SESSION['txtNumberM']);?></p> [Country code, Number]<br /><br />
                    ...
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtStorageM']; unset($_SESSION['txtStorageM']);?></p> [Size of internal storage (e.g. 1TB SSD)]<br /><br />
                    ...
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtBatteryM']; unset($_SESSION['txtBatteryM']);?></p> [Battery health, cycle count (e.g. Battery Health: 98, Cycles: 80)]<br /><br />
                    ...
                    <input type="text" name="Encryption" size="32" value="<?php 
                        if(isset($_SESSION['txtEncryptionF'])) {
                            echo $_SESSION['txtEncryptionF'];
                            unset($_SESSION['txtEncryptionF']);
                        }
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtEncryptionM']; unset($_SESSION['txtEncryptionM']);?></p> [Device Encryption (e.g. Encryption App: FileVault)]<br /><br />

                    <!-- Account field -->
                    <label for="txtAccount">Account Information:</label><br />
                    <input type="text" name="Account" size="32" value="<?php 
                        if(isset($_SESSION['txtAccountF'])) {
                            echo $_SESSION['txtAccountF'];
                            unset($_SESSION['txtAccountF']);
                        }
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtAccountM']; unset($_SESSION['txtAccountM']);?></p> [Linked account information (e.g. iCloud Account: user@icloud.com)]<br /><br />

                    <!-- Passcode field -->
                    <label for="txtPasscode">Screen Lock Information:</label><br />
                    <input type="text" name="Passcode" size="32" value="<?php 
                        if(isset($_SESSION['txtPasscodeF'])) {
                            echo $_SESSION['txtPasscodeF'];
                            unset($_SESSION['txtPasscodeF']);
                        }
                    ?>" required/><p class="error-message"><?php echo $_SESSION['txtPasscodeM']; unset($_SESSION['txtPasscodeM']);?></p> [Passcode, Password, Biometrics (e.g. Passcode: 1234)]<br /><br />
