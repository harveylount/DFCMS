    ...
    <div id="pagewrap">
        ...
        <div id="logout-bar">
            <div class="left-group">
                ...
                <a href="<?php echo "listImageFiles.php?identifier=" . $identifier . "&EvidenceID=" . $evidenceID ?>" class="logout-button">← Images</a>
            </div>
        ...
        <section id="LBU">
            ...
            <?php
                ...
                echo "<tr><td rowspan='2' style='font-size: 50px; font-weight: bold; border: 2px solid #5AAAFF; background-color: #5AAAFF; color: white;'>Upload Image</td> 
            ...
            <fieldset class="field-set width">
                ...
                <button type="submit" name="subImageEvent">Upload File</button>
            </form>
