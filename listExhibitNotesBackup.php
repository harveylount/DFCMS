    ...
    <div id="pagewrap">
        ...
        <section id="LBU">
            ...
            <?php
                ...
                echo "<tr><td rowspan='2' style='font-size: 42px; font-weight: bold; border: 2px solid #5AAAFF; background-color: #5AAAFF; color: white;'>Backup Exhibit Notes</td> 
                ...
                echo "<tr><th class='lbu-dark' style='width: 160px;'>Case Reference</th><th class='lbu-dark' style='width: 100px;'>Exhibit Reference</th><th class='lbu-dark'>Editor of Backup</th><th class='lbu-dark' style='width: 160px;'>Timestamp</th><th class='lbu-dark' style='width: 100px;'></th></tr>";
                

                $sql = "SELECT ExhibitNotesBackupID, Identifier, CaseReference, EvidenceID, ExhibitRef, Timestamp1, EditorOfBackupFullName, EditorOfBackupUsername FROM exhibitnotesbackup WHERE Identifier = ? AND EvidenceID = ?";
                $stmt = $connection->prepare($sql);
                $stmt->bind_param("ss", $identifier, $evidenceID);
                $stmt->execute();
                ...
                while ($row = $results->fetch_assoc()) {
                    ...
                    echo '<td><a href="viewExhibitNotesBackup.php?identifier=' . $row['Identifier'] . '&EvidenceID=' . $row['EvidenceID'] .  '&ExhibitNotesBackupID=' . $row['ExhibitNotesBackupID'] . '">View Backup</a></td>';
                    echo '</tr>';
                }
