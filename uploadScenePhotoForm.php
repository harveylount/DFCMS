    ...
    <div id="pagewrap">
        ...
        <section id="LBU">
            ...
            <?php
                ...
                echo "<tr><td rowspan='2' style='font-size: 48px; font-weight: bold; border: 2px solid #5AAAFF; background-color: #5AAAFF; color: white;'>Upload Scene Photo</td> 
            ...
            <fieldset class="field-set width">
                ...
                <button type="submit" name="subScenePhotoEvent">Upload File</button>
            </form>
