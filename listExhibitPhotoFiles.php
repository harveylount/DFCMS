        ...
        <section id="LBU">
            ...
            <?php
                ...
                echo '<div id="navcase-bar">
                    <a href="uploadExhibitPhotoForm.php?identifier=' . $identifier . '&EvidenceID=' . $evidenceID . '" id="navcase-button">Upload File</a>
                    </div>';
                echo "<br/>";
                ...
                echo "<tr><td rowspan='2' style='font-size: 50px; font-weight: bold; border: 2px solid #5AAAFF; background-color: #5AAAFF; color: white;'>Exhibit Photo Files</td> 
                ...
                while ($row = $results->fetch_assoc()) {
                    if ($row['UploadType'] == 'ExhibitPhoto') {
                        echo '<tr>';
