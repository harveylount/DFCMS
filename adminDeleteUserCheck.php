        ...
        <section id="LBU">
            ...
            <p>
                <?php
                    ...
                    echo "<tr><td rowspan='2' style='font-size: 50px; font-weight: bold; border: 2px solid #5AAAFF; background-color: #5AAAFF; color: white;'>Confirm Delete User</td> </tr>";
                    echo "</table>";
                    echo "<br/>";    
                    ...
                    echo "<b>Do you want to delete user: </b>" . $deleteFullName . " (" . $deleteUsername . ") </br></br>";
                ?>

                <form method="post" action="adminDeleteUserInsert.php?user=<?php echo $user ?>">

                    <label for="txtConfirm">Yes or No: *</label><br />
                    <input type="text" name="txtConfirm" required/><p class="error-message"><?php 
                        if(isset($_SESSION['txtConfirmM'])) {
                            echo $_SESSION['txtConfirmM'];
                            unset($_SESSION['txtConfirmM']);
                        }
                    ?> </p><br /><br />
